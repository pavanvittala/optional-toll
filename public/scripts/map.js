...
var count = 0;
var map;    //Global reference to the map
var markersArray = [];  //Holds all of the markers that are placed on the map
var directionsDisplay; 

/*Function for clearing all the markers in the markersArray*/
...
/*Initialize map and run code for setting up autocomplete search system*/
function initMap() {
